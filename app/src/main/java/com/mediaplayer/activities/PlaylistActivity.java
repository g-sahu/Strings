...
public class PlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            MediaLibraryManager.sortTracklist(MediaPlayerConstants.KEY_PLAYLIST_USER);
    ...
    public void callMediaplayerActivity(View view) {
        ...
        intent.putExtra(MediaPlayerConstants.KEY_SELECTED_PLAYLIST, MediaPlayerConstants.KEY_PLAYLIST_USER);
